...
# --- Updated STT Languages (with popular languages first) ---
STT_LANGUAGES = {
    # Most common languages first for better user experience
    "English 🇬🇧": "en",
    "العربية 🇸🇦": "ar",
    "Spanish 🇪🇸": "es",
    "French 🇫🇷": "fr",
    ...
    "Hindi 🇮🇳": "hi",
    "Turkish 🇹🇷": "tr",
    # The rest are alphabetically sorted
    "Afrikaans 🇿🇦": "af",
    "Albanian 🇦🇱": "sq",
    "Amharic 🇪🇹": "am",
    "Armenian 🇦🇲": "hy",
...
def get_tts_user_voice_in_memory(user_id: str) -> str:
    # --- Default TTS voice updated here ---
    # The default TTS voice is now "en-US-EricNeural", as requested.
...
def build_stt_language_keyboard():
    markup = InlineKeyboardMarkup(row_width=3)
    buttons = []
    # --- Language order is now based on the STT_LANGUAGES dictionary order
    for lang_name, lang_code in STT_LANGUAGES.items():
        buttons.append(
